...
class TencentCloudChatSelectableRegionState
    extends State<TencentCloudChatSelectableRegion>
  ...
  void _handleFocusChanged() {
    if (!widget.focusNode.hasFocus) {
      if (kIsWeb) {
        TencentCloudChatPlatformSelectableRegionContextMenu.detach(
            _selectionDelegate);
      }
      _clearSelection();
    }
    if (kIsWeb) {
      TencentCloudChatPlatformSelectableRegionContextMenu.attach(
          _selectionDelegate);
    }
  }
